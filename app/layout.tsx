  ...
  return (
    <html lang="en">
      <Head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/workspaces/malleablemind.ai/app/favicon-32x32.png" /> 

        {/* Favicon for Apple devices */}
        <link rel="apple-touch-icon" sizes="180x180" href="/workspaces/malleablemind.ai/app/apple-touch-icon-152x152.png" /> 
      </Head>
